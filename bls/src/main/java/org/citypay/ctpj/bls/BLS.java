...
public class BLS {
  ...
  static {
    ...
    try
    {
      ...
      Preconditions.checkState(GetVersionString().equals(CTPJ_VERSION),
              "ctpjbls:  C++ Source Version doesn't match Java Source version:" +
              "C++: " + GetVersionString() + " Java: " + CTPJ_VERSION);
