...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("CTP2"));
        ...
        assertEquals(valueOf(200000000), usCoded.parseObject("CTP 2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("CTP2.0"));
        ...
        assertEquals(valueOf(202222420000000L), us.parseObject("CTP2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(200000), usCoded.parseObject("mCTP 2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("mCTP2"));
        ...
        assertEquals(valueOf(200000), usCoded.parseObject("₥CTP 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XDC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥CTP 2"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("₥CTP2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("₥XDC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mCTP2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥CTP 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XDC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mCTP 2,022,224"));
        ...
        assertEquals(valueOf(435), us.parseObject("uCTP4.35"));
        assertEquals(valueOf(435), us.parseObject("uXDC4.35"));
        assertEquals(valueOf(435), us.parseObject("µCTP4.35"));
        assertEquals(valueOf(435), us.parseObject("µXDC4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uCTP 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXDC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µCTP 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXDC 4.35"));
        // fractional satoshi; round up
        assertEquals(valueOf(435), us.parseObject("uCTP4.345"));
        ...
        assertEquals(valueOf(-10), us.parseObject("(µCTP0.100)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("CTP 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("CTP1.00"));
        ...
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mCTP 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mCTP1.00"));
        ...
        assertEquals(parseCoin("0.001"), cp.parseObject("₥CTP 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("₥CTP1.00"));
        ...
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uCTP 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uCTP1.00"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("µCTP 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µCTP1.00"));
        ...
        // satoshi
        assertEquals(parseCoin("0.00000001"), cp.parseObject("uCTP 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("uCTP0.01"));
        ...
        assertEquals(parseCoin("0.00000001"), cp.parseObject("µCTP 0.01"));
        assertEquals(parseCoin("0.00000001"), sp.parseObject("µCTP0.01"));
        ...
        // cents
        assertEquals(parseCoin("0.01234567"), cp.parseObject("cCTP 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("cCTP1.234567"));
        ...
        assertEquals(parseCoin("0.01234567"), cp.parseObject("¢CTP 1.234567"));
        assertEquals(parseCoin("0.01234567"), sp.parseObject("¢CTP1.234567"));
        ...
        // dekacoins
        assertEquals(parseCoin("12.34567"), cp.parseObject("daCTP 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daCTP1.234567"));
        ...
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hCTP 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hCTP1.234567"));
        ...
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kCTP 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kCTP1.234567"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MCTP 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MCTP1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        BtcFormat usCoded = BtcFormat.getCodeInstance(Locale.US);
        assertEquals("µCTP 0.01", usCoded.format(1));
        assertEquals("CTP 1.00", usCoded.format(COIN));

        /* Do not insert unneeded space BEFORE currency-code */
        BtcFormat frCoded = BtcFormat.getCodeInstance(Locale.FRANCE);
        assertEquals("0,01 µCTP", frCoded.format(1));
        assertEquals("1,00 CTP", frCoded.format(COIN));
        ...
        assertEquals("µCTP 0,01", deCoded.format(1));
        assertEquals("CTP 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("CTP 1", codedZero.format(COIN));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µCTP 1,000,000", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µĐ1,000,000", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µCTP 1,000,000", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µĐ999,999", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("µCTP 999,999", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("Đ1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("CTP 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(100)));
        assertEquals("µCTP 1", codedZero.format(Coin.valueOf(100)));
        assertEquals("µĐ1", symbolZero.format(Coin.valueOf(50)));
        assertEquals("µCTP 1", codedZero.format(Coin.valueOf(50)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(49)));
        assertEquals("µCTP 0", codedZero.format(Coin.valueOf(49)));
        assertEquals("µĐ0", symbolZero.format(Coin.valueOf(1)));
        assertEquals("µCTP 0", codedZero.format(Coin.valueOf(1)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("µCTP 500,000", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49950000)));
        assertEquals("µCTP 499,500", codedZero.format(Coin.valueOf(49950000)));
        assertEquals("µĐ499,500", symbolZero.format(Coin.valueOf(49949999)));
        assertEquals("µCTP 499,500", codedZero.format(Coin.valueOf(49949999)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049000)));
        assertEquals("µCTP 500,490", codedZero.format(Coin.valueOf(50049000)));
        assertEquals("µĐ500,490", symbolZero.format(Coin.valueOf(50049001)));
        assertEquals("µCTP 500,490", codedZero.format(Coin.valueOf(50049001)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(49999950)));
        assertEquals("µCTP 500,000", codedZero.format(Coin.valueOf(49999950)));
        assertEquals("µĐ499,999", symbolZero.format(Coin.valueOf(49999949)));
        assertEquals("µCTP 499,999", codedZero.format(Coin.valueOf(49999949)));
        assertEquals("µĐ500,000", symbolZero.format(Coin.valueOf(50000049)));
        assertEquals("µCTP 500,000", codedZero.format(Coin.valueOf(50000049)));
        assertEquals("µĐ500,001", symbolZero.format(Coin.valueOf(50000050)));
        assertEquals("µCTP 500,001", codedZero.format(Coin.valueOf(50000050)));
        ...
        assertEquals("CTP 1.00", codedTwo.format(COIN));
        assertEquals("µĐ999,999.99", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("µCTP 999,999.99", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("CTP 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("µĐ1.00", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("µCTP 1.00", codedTwo.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("µCTP 0.50", codedTwo.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("µCTP 0.49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("µCTP 0.01", codedTwo.format(Coin.valueOf(1)));
        ...
        assertEquals("CTP 1.000", codedThree.format(COIN));
        assertEquals("µĐ999,999.99", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("µCTP 999,999.99", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("Đ1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("CTP 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("₥Đ0.001", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mCTP 0.001", codedThree.format(Coin.valueOf(100)));
        assertEquals("µĐ0.50", symbolThree.format(Coin.valueOf(50)));
        assertEquals("µCTP 0.50", codedThree.format(Coin.valueOf(50)));
        assertEquals("µĐ0.49", symbolThree.format(Coin.valueOf(49)));
        assertEquals("µCTP 0.49", codedThree.format(Coin.valueOf(49)));
        assertEquals("µĐ0.01", symbolThree.format(Coin.valueOf(1)));
        assertEquals("µCTP 0.01", codedThree.format(Coin.valueOf(1)));
    }
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 CTP", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("CTP -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("Đ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("CTP -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("Đ-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(CTP 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(Đ1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("CTP -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("CTP -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("CTP") && ! codePat.contains("(^|[^Đ])Đ([^Đ]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("Đ") && !symPat.contains("CTP") && !symPat.contains("¤¤"));

        assertEquals("CTP #,##0.00;(CTP #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format CTP #,##0.00;(CTP #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format CTP #,##0.0000;(CTP #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format CTP #.000;CTP -#.000", f.toString());
        assertEquals("mCTP 1000.000", f.format(COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("CTP -1,00", built.format(COIN.multiply(-1)));
        built = BtcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mCTP1,000.00", built.format(COIN));
        built = BtcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();
