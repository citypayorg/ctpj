...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 CTP", COIN.toFriendlyString());
        assertEquals("1.23 CTP", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 CTP", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 CTP", valueOf(1, 23).negate().toFriendlyString());
    }
