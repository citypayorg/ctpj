...
public class MessageSignerTest {
    ...
    public void verifySignatureTest()
    {
        ...
        String message = "125.180.155.64:3999915239445811bd94fd9f0b98eb669fa2c1dc1bda3da99f4c69ed40ce1ccc666e3be757d966d927e90173f970a0c70208";
        StringBuilder errorMessage = new StringBuilder();
        assert(MessageSigner.verifyMessage(publicKey, vchSig, message, errorMessage));

        assert(!MessageSigner.verifyMessage(publicKey, vchSig, "125.180.155.64:3999915239445811bd94fd9f0b98eb669fa2c1dc1bda3da99f4c69ed40ce1ccc666e3be757d966d927e90173f970a0c70208", errorMessage));
