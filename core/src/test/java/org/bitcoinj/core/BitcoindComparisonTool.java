...
/**
 * A tool for comparing the blocks which are accepted/rejected by ctpd/ctpj
 * It is designed to run as a testnet-in-a-box network between a single ctpd node and ctpj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: ctpjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
