...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new full verification ctpj app. Instantiate it with a directory
...
public class FullPrunedWalletAppKit extends AbstractIdleService {
    ...
    public FullPrunedWalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initCtp(false, true);
        context.initCtpSync(directory.getAbsolutePath());
    }
