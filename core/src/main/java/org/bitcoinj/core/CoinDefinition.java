...
public class CoinDefinition {
    ...
    public static final String coinName = "Ctp";
    public static final String coinTicker = "CTP";
    public static final String coinURIScheme = "ctp";
    ...
    public static final String UNSPENT_API_URL = "https://chainz.cryptoid.info/ctp/api.dws?q=unspent";
    ...
    public static final String BLOCKEXPLORER_BASE_URL_PROD = "http://explorer.citypay.org/";    //blockr.io
    public static final String BLOCKEXPLORER_ADDRESS_PATH = "address/";             //blockr.io path
    public static final String BLOCKEXPLORER_TRANSACTION_PATH = "tx/";              //blockr.io path
    public static final String BLOCKEXPLORER_BLOCK_PATH = "block/";                 //blockr.io path
    public static final String BLOCKEXPLORER_BASE_URL_TEST = "http://test.explorer.citypay.org/";

    public static final String DONATION_ADDRESS = "XnpRy4zRUc38W18mKFKVYBiiserB82vtSo";  //Hash Engineering donation CTP address
    ...
    public static final long INSTANTX_FEE = 100000; //0.001 CTP (updated for 12.1)
    ...
    public static final int Port    = 39999;       //protocol.h GetDefaultPort(testnet=false)
    public static final int TestPort = 29999;     //protocol.h GetDefaultPort(testnet=true)
    ...
    static public String genesisHash = "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"; //main.cpp: hashGenesisBlock
    static public String genesisMerkleRoot = "4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b";
    ...
    static public String genesisTxInBytes  = "04ffff001d01044c575468652054696d657320323031392d30392d3139206920776f726b6564204369746942616e6b2062757420436974795061792e6f726720697320646966666572656e7420666f722062616e6b696e672053657276696365";
