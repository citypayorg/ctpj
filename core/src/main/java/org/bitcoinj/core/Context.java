...
import org.citypay.ctpj.bls.BLS;
import org.slf4j.*;
...
public class Context {
    ...
    // Ctp Specific
    //
    private boolean initializedCtp = false;

    public boolean isInitializedCtp() {
        return initializedCtp;
    }

    public void initCtp(boolean liteMode, boolean allowInstantX) {
        initCtp(liteMode, allowInstantX, null);
    }
    ...
    public void closeCtp() {
        ...
        initializedCtp = false;
        governanceManager = null;
    }

    public void initCtpSync(final String directory)
    {
