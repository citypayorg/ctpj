...
public abstract class NetworkParameters {
    ...
    public static final String ID_DEVNET = "org.ctp.dev";
    /** Unit test network. */
     ...
     *
     * <p>The second block in a devnet chain is a known constant shared between all Ctp DevNet implimentations for a
